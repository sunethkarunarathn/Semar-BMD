...
```
pkg update -y;pkg upgrade -y;pkg install nodejs-lts -y;pkg install git -y;git clone https://github.com/dcode-denpa/Semar-BMD;cd Semar-BMD;rm -rf session.json;node index
```
### 2. Scan Barcode
